...
function EditClientPage() {
  ...
  const { data: archivedTasks = [], isLoading: loadingArchivedTasks } = useArchivedClientTasks(
    clientId,
    ...
    if (user && isOffline()) {
      ...
      if (avatarFile) {
        await enqueueOfflineOperation({
          ...
          payload: {
            table: "client_avatar_updates",
            bucket: "task-attachments",
            blob: avatarFile,
            attachment: {
              client_id: clientId,
              storage_path: nextAvatarPath,
              mime_type: avatarFile.type || "image/png",
            },
          },
        });
      }
