...
function ConversationsPage() {
  ...
  const openTask = (taskId: string) => {
    void navigate({ to: "/tasks/list", search: { task: taskId, mine: undefined } });
  };
              ...
              <div className="flex items-start gap-2">
                ...
                {unread && (
                  <span
                    ...
                    className="mt-1.5 h-2.5 w-2.5 shrink-0 rounded-full bg-[#5d6e3e] shadow-sm"
                  />
                )}
                <span
                  role="button"
                  ...
                  className={cn(
                    "grid h-6 w-6 shrink-0 cursor-pointer place-items-center rounded-full text-[#5d6e3e] transition-colors hover:bg-[#5d6e3e]/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary",
              ...
              <div className="flex items-center gap-3 border-b bg-card px-5 py-3.5">
                ...
                {isSelectedConversationClosed && (
                  <Button
                    ...
                    size="sm"
                    variant="outline"
                    className="h-8 shrink-0 gap-1.5 border-[#5d6e3e]/30 text-xs text-[#5d6e3e] hover:bg-[#5d6e3e]/10"
