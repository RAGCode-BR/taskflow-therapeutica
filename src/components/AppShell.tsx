  ...
  return (
    <div className="flex h-dvh overflow-hidden bg-background">
      ...
      >
        ...
        >
          <div
            className={`flex shrink-0 items-center justify-center ${sidebarOpen ? "h-24 w-44" : "h-10 w-10"}`}
          >
            <img
              src={therapeuticaLogo}
              alt="Therapeutica Farmácia"
              className="h-full w-full object-contain"
            />
          </div>
          {sidebarOpen && <span className="text-lg font-semibold leading-none">Task Flow</span>}
        </div>
            ...
            return (
              ...
              >
                ...
                {n.to === "/conversations" && conversationsUnread > 0 && (
                  <span className="ml-auto grid h-5 min-w-5 place-items-center rounded-full bg-primary px-1 text-[10px] font-bold text-primary-foreground shadow-sm">
          ...
          >
            <div className="flex items-center justify-between px-5 py-4">
              <div className="flex flex-col items-center gap-3">
                <div className="flex h-24 w-44 shrink-0 items-center justify-center">
                  <img
                    src={therapeuticaLogo}
                    alt="Therapeutica Farmácia"
                    className="h-full w-full object-contain"
                ...
                <span className="text-lg font-semibold leading-none">Task Flow</span>
              </div>
